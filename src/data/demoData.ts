...
export const DEMO_LANES: Lane[] = [
  ...
  { id: 'activities',    name: 'Activities',    emoji: '🎯', color: '#f59e0b', visible: false, isDefault: true, order: 7 },
  ...
  { id: 'items',         name: 'Items',         emoji: '📦', color: '#6366f1', visible: false, isDefault: true, order: 10 },
...
export const DEMO_EVENTS: TimelineEvent[] = [
  // Locations
  { id: 'demo-evt-berlin',     laneId: 'locations',     emoji: '🏙️', title: 'Berlin',              description: 'Grew up and worked in Berlin',            type: 'range', startYear: 2000, endYear: 2022,   color: '#3b82f6' },
  { id: 'demo-evt-seasia',     laneId: 'locations',     emoji: '🌴', title: 'Southeast Asia',       description: 'Vietnam, Thailand, Bali — sabbatical year', type: 'range', startYear: 2022, endYear: 2023,   color: '#0ea5e9' },
  { id: 'demo-evt-munich',     laneId: 'locations',     emoji: '🏔️', title: 'Munich',               description: 'Moved to Munich after returning',           type: 'range', startYear: 2023, endYear: 2035,   color: '#3b82f6' },
  ...
  { id: 'demo-evt-leadeng',    laneId: 'work',          emoji: '🚀', title: 'Lead Engineer',        description: 'Returned with new perspective — promoted to Lead Engineer at Munich startup', type: 'range', startYear: 2023, endYear: 2029, color: '#059669' },
  { id: 'demo-evt-newjob',     laneId: 'work',          emoji: '💼', title: '?New Job?',            description: 'Future opportunity',                         type: 'range', startYear: 2029.5, endYear: 2039.5, color: '#059669',
    valueProjection: {
      startValue: 0,
      spotChanges: [],
      growthPeriods: [],
      deposits: [{ id: 'demo-dep-newjob', label: 'Monthly salary', amount: 10, frequency: 'monthly', startYear: 2029.5, endYear: 2039.5 }],
    },
  },
  ...
  // Travel
  { id: 'demo-evt-sabbatical', laneId: 'travel',        emoji: '🌏', title: 'Sabbatical — SE Asia', description: 'A year to explore — Vietnam, Thailand, Bali', type: 'range', startYear: 2022, endYear: 2023, color: '#0ea5e9' },
  ...
  // Achievements
  { id: 'demo-evt-diving',     laneId: 'achievements',  emoji: '🤿', title: 'PADI Open Water Diver', description: 'Got certified diving in Koh Tao, Thailand', type: 'point', startYear: 2022.6, color: '#0ea5e9' },
