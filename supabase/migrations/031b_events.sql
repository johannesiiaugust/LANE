INSERT INTO public.persona_events (persona_id, lane_name, title, description, type, start_year, end_year, color) VALUES
  ('a0000000-0000-0000-0000-000000000133', 'Place & Travel', 'Santa Barbara, California', 'Grew up in a Christian household; began performing in church choir.', 'range', 1984, 2001, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000133', 'Place & Travel', 'Los Angeles, California', 'Moved to LA to pursue music career full-time.', 'range', 2001, 2026, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000133', 'Work & Education', 'Signed to Capitol Records', 'Released debut single "I Kissed a Girl," reaching #1 in 20 countries.', 'point', 2007, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000133', 'Work & Education', 'Teenage Dream era', 'Fifth studio album produced five consecutive #1 Billboard Hot 100 singles.', 'range', 2010, 2012, '#10b981'),
  ('a0000000-0000-0000-0000-000000000133', 'Work & Education', 'Witness & Las Vegas residency', 'Sixth album released; began multi-year Las Vegas residency at Resorts World.', 'range', 2017, 2024, '#10b981'),
  ('a0000000-0000-0000-0000-000000000133', 'Relations & Family', 'Marriage to Orlando Bloom', 'Engaged 2019; married in intimate ceremony; welcomed daughter Daisy in 2020.', 'range', 2019, 2026, '#ec4899'),
  ('a0000000-0000-0000-0000-000000000133', 'Activities', 'American Idol judge', 'Served as judge on American Idol seasons 16–18, boosting show ratings.', 'range', 2018, 2020, '#f59e0b'),
  ('a0000000-0000-0000-0000-000000000133', 'Health', 'Mental health advocacy', 'Publicly discussed anxiety and depression; became vocal mental health advocate.', 'point', 2017, null, '#ef4444'),
  ('a0000000-0000-0000-0000-000000000133', 'Items', 'Signed guitar collection', 'Collects vintage and custom guitars; notable Gibson and Fender pieces.', 'point', 2010, null, '#64748b');

INSERT INTO public.persona_events (persona_id, lane_name, title, description, type, start_year, end_year, color) VALUES
  ('a0000000-0000-0000-0000-000000000134', 'Place & Travel', 'Tottenham, London', 'Born and raised in North London; sang in local church and school choirs.', 'range', 1988, 2006, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000134', 'Place & Travel', 'Brighton, East Sussex', 'Moved to Brighton briefly to develop songwriting independently.', 'range', 2006, 2008, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000134', 'Place & Travel', 'Los Angeles (recording trips)', 'Frequently recorded at LA studios including Chalice and Conway.', 'range', 2010, 2022, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000134', 'Work & Education', '19 — debut album', 'Debut album reached #1 in the UK; launched career with "Chasing Pavements."', 'point', 2008, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000134', 'Work & Education', '21 — global breakthrough', 'Best-selling album of 2011 and 2012 worldwide; won six Grammy Awards.', 'range', 2011, 2012, '#10b981'),
  ('a0000000-0000-0000-0000-000000000134', 'Work & Education', '30 — comeback album', 'First album in six years; "Easy On Me" broke Spotify streaming records.', 'point', 2021, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000134', 'Health', 'Vocal surgery', 'Underwent emergency vocal cord surgery; cancelled tour to recover.', 'point', 2011, null, '#ef4444'),
  ('a0000000-0000-0000-0000-000000000134', 'Relations & Family', 'Son Angelo born', 'Welcomed son Angelo with partner Simon Konecki; later married then divorced.', 'point', 2012, null, '#ec4899'),
  ('a0000000-0000-0000-0000-000000000134', 'Assets', 'London property portfolio', 'Purchased multiple properties in North London worth over £10 million combined.', 'range', 2012, 2026, '#14b8a6');

INSERT INTO public.persona_events (persona_id, lane_name, title, description, type, start_year, end_year, color) VALUES
  ('a0000000-0000-0000-0000-000000000135', 'Place & Travel', 'Halifax, West Yorkshire', 'Born in Halifax; family moved frequently across England due to father''s work.', 'range', 1991, 2008, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000135', 'Place & Travel', 'London — busking years', 'Moved to London at 16; slept on sofas and busked at Tube stations.', 'range', 2008, 2011, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000135', 'Place & Travel', 'Suffolk countryside estate', 'Bought family estate "Sheeran Ranch" in Suffolk; base for family life.', 'range', 2012, 2026, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000135', 'Work & Education', '+  debut album', 'Debut album hit #1 UK; "The A Team" earned him an Ivor Novello Award.', 'point', 2011, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000135', 'Work & Education', 'x and ÷ global tours', '"Multiply" and "Divide" tours among highest-grossing in history.', 'range', 2014, 2019, '#10b981'),
  ('a0000000-0000-0000-0000-000000000135', 'Work & Education', 'Mathematics tour', 'Equals / Mathematics era tour grossed over $1 billion globally.', 'range', 2022, 2024, '#10b981'),
  ('a0000000-0000-0000-0000-000000000135', 'Relations & Family', 'Married Cherry Seaborn', 'Married childhood friend Cherry Seaborn; two daughters Lyra and Jupiter.', 'range', 2019, 2026, '#ec4899'),
  ('a0000000-0000-0000-0000-000000000135', 'Health', 'Wife''s cancer diagnosis', 'Revealed wife Cherry had a tumour; paused work to support family.', 'point', 2022, null, '#ef4444'),
  ('a0000000-0000-0000-0000-000000000135', 'Activities', 'Songwriter for other artists', 'Co-wrote "Love Yourself" for Justin Bieber and tracks for One Direction.', 'range', 2013, 2017, '#f59e0b');

INSERT INTO public.persona_events (persona_id, lane_name, title, description, type, start_year, end_year, color) VALUES
  ('a0000000-0000-0000-0000-000000000136', 'Place & Travel', 'London, Ontario, Canada', 'Born and raised in small-city Canada; discovered via YouTube videos at age 12.', 'range', 1994, 2008, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000136', 'Place & Travel', 'Atlanta, Georgia (training)', 'Relocated to Atlanta under Scooter Braun and Usher''s mentorship.', 'range', 2008, 2010, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000136', 'Place & Travel', 'Los Angeles / touring globally', 'Global tours and LA residency as career took off internationally.', 'range', 2010, 2026, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000136', 'Work & Education', 'My World EP debut', 'Debut EP sold over one million copies; youngest solo artist to debut at #5 on Billboard 200.', 'point', 2009, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000136', 'Work & Education', 'Purpose album', 'Fourth studio album spawned multiple #1 singles including "Sorry" and "Love Yourself."', 'point', 2015, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000136', 'Work & Education', 'Justice album', 'Sixth album debuted at #1 in 100+ countries on streaming platforms.', 'point', 2021, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000136', 'Relations & Family', 'Married Hailey Baldwin', 'Married model Hailey Baldwin in courthouse ceremony; later formal wedding.', 'range', 2018, 2026, '#ec4899'),
  ('a0000000-0000-0000-0000-000000000136', 'Health', 'Lyme disease diagnosis', 'Publicly revealed Lyme disease diagnosis; cited exhaustion and depression.', 'point', 2019, null, '#ef4444'),
  ('a0000000-0000-0000-0000-000000000136', 'Activities', 'Bieber Fever philanthropy', 'Donated millions to COVID-19 relief and youth mental health organisations.', 'range', 2020, 2023, '#f59e0b');

INSERT INTO public.persona_events (persona_id, lane_name, title, description, type, start_year, end_year, color) VALUES
  ('a0000000-0000-0000-0000-000000000137', 'Place & Travel', 'Boca Raton, Florida', 'Born in Boca Raton; family of Italian-American heritage; performed locally.', 'range', 1993, 2010, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000137', 'Place & Travel', 'New York City — Broadway', 'Moved to NYC to perform in 13 on Broadway at age 15.', 'range', 2008, 2011, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000137', 'Place & Travel', 'Los Angeles / Worldwide tours', 'Settled in LA while touring globally across multiple world tours.', 'range', 2011, 2026, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000137', 'Work & Education', 'Victorious / Sam & Cat (Nickelodeon)', 'Starred in Victorious and spin-off Sam & Cat; fan base grew exponentially.', 'range', 2010, 2014, '#10b981'),
  ('a0000000-0000-0000-0000-000000000137', 'Work & Education', 'Thank U, Next album', 'Album broke multiple streaming records; released days after a public breakup.', 'point', 2019, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000137', 'Work & Education', 'Positions and eternal sunshine', 'Back-to-back #1 albums cementing status as a defining pop voice.', 'range', 2020, 2024, '#10b981'),
  ('a0000000-0000-0000-0000-000000000137', 'Health', 'Lupus & kidney transplant', 'Revealed lupus diagnosis and kidney transplant from best friend Francia Raísa.', 'point', 2017, null, '#ef4444'),
  ('a0000000-0000-0000-0000-000000000137', 'Relations & Family', 'Married Dalton Gomez', 'Married real estate agent Dalton Gomez in small home ceremony.', 'range', 2021, 2023, '#ec4899'),
  ('a0000000-0000-0000-0000-000000000137', 'Activities', 'r.e.m. beauty brand launch', 'Launched own cosmetics brand r.e.m. beauty with emphasis on inclusivity.', 'point', 2021, null, '#f59e0b');

INSERT INTO public.persona_events (persona_id, lane_name, title, description, type, start_year, end_year, color) VALUES
  ('a0000000-0000-0000-0000-000000000138', 'Place & Travel', 'Los Angeles, California', 'Born and homeschooled in LA; parents are musicians and actors.', 'range', 2001, 2026, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000138', 'Work & Education', '"Ocean Eyes" viral debut', 'Released "Ocean Eyes" on SoundCloud at age 14; went globally viral overnight.', 'point', 2015, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000138', 'Work & Education', 'When We All Fall Asleep… album', 'Debut album swept the Grammys; youngest artist to win all four main categories.', 'point', 2019, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000138', 'Work & Education', 'Happier Than Ever album', 'Second album debuted at #1 in 32 countries; accompanied by Netflix concert film.', 'point', 2021, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000138', 'Work & Education', 'James Bond theme "No Time to Die"', 'Youngest artist to write and record an official James Bond theme.', 'point', 2020, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000138', 'Health', 'Tourette syndrome disclosure', 'Publicly disclosed Tourette syndrome diagnosis during Instagram Live.', 'point', 2021, null, '#ef4444'),
  ('a0000000-0000-0000-0000-000000000138', 'Relations & Family', 'Relationship with Jesse Rutherford', 'Brief public relationship with The Neighbourhood frontman Jesse Rutherford.', 'range', 2022, 2023, '#ec4899'),
  ('a0000000-0000-0000-0000-000000000138', 'Activities', 'Vegan lifestyle advocacy', 'Vocal advocate for veganism and climate action since teen years.', 'range', 2018, 2026, '#f59e0b'),
  ('a0000000-0000-0000-0000-000000000138', 'Items', 'Signature oversized fashion', 'Popularised gender-neutral oversized streetwear; collaborated with Gucci.', 'range', 2019, 2023, '#64748b');

INSERT INTO public.persona_events (persona_id, lane_name, title, description, type, start_year, end_year, color) VALUES
  ('a0000000-0000-0000-0000-000000000139', 'Place & Travel', 'Toronto, Ontario, Canada', 'Born and raised in Toronto''s Forest Hill neighbourhood; mixed heritage.', 'range', 1986, 2009, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000139', 'Place & Travel', 'Los Angeles / Atlanta / Toronto', 'Split time between cities as rap career expanded; maintains Toronto ties.', 'range', 2009, 2026, '#3b82f6'),
  ('a0000000-0000-0000-0000-000000000139', 'Work & Education', 'Degrassi: The Next Generation', 'Played wheelchair-user Jimmy Brooks; launched him to Canadian fame.', 'range', 2001, 2007, '#10b981'),
  ('a0000000-0000-0000-0000-000000000139', 'Work & Education', 'Thank Me Later debut album', 'Debut reached #1 on Billboard 200; established "Toronto sound" rap-singing style.', 'point', 2010, null, '#10b981'),
  ('a0000000-0000-0000-0000-000000000139', 'Work & Education', 'Certified Lover Boy / Certified Trilogy', 'Multiple #1 albums; longest-running artist at #1 on Billboard Hot 100.', 'range', 2021, 2023, '#10b981'),
  ('a0000000-0000-0000-0000-000000000139', 'Relations & Family', 'Son Adonis born', 'Son Adonis born with French artist Sophie Brussaux; paternity confirmed in 2018.', 'point', 2017, null, '#ec4899'),
  ('a0000000-0000-0000-0000-000000000139', 'Assets', 'NOCTA brand & OVO Sound', 'Founded OVO Sound record label and NOCTA Nike collaboration clothing line.', 'range', 2012, 2026, '#14b8a6'),
  ('a0000000-0000-0000-0000-000000000139', 'Activities', 'Beef with Kendrick Lamar', 'Public rap feud with Kendrick Lamar dominated music discourse in 2024.', 'point', 2024, null, '#f59e0b'),
  ('a0000000-0000-0000-0000-000000000139', 'Health', 'Hip surgery', 'Underwent hip surgery and took extended break from touring.', 'point', 2022, null, '#ef4444');
